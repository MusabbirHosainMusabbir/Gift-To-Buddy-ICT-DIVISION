...
import com.arena.gifttobuddy.Views.InstaLogin;
...
public class InstagramApp {
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
                + mCallbackUrl + "&response_type=code&display=touch&scope=user_profile,user_media";
        InstaLogin.OAuthDialogListener listener = new InstaLogin.OAuthDialogListener() {
        @Override
